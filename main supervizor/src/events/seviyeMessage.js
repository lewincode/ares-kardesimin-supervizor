...
module.exports = async (message) => {
  ...
  if (message.author.bot) return;
	...
	const background = await loadImage("https://cdn.discordapp.com/attachments/1165114849957793816/1165116246530994186/aresxrd.png");            
	...
	const attachment = new MessageAttachment(image.toBuffer(), 'aresxrd.png');
